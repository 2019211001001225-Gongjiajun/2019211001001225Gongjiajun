        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>order Date</td>
                    <%
                        com.gongjiajun.model.Order o=(com.gongjiajun.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.gongjiajun.dao.UserDao userDao=new com.gongjiajun.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.gongjiajun.model.Payment.findByPaymentId(con,n);
                        %>
